...
function opttableselect(tablesel) {
    quocngu = tablesel;
    $("#keyboard").css({ 'font-family': 'Tahoma, "Tai Lanna", "Cambria Tai", "Lanexang Mon4", "Microsoft New Tai Lue", sans-serif, "Tai Son La", TaiViet, "Segoe Ahom Print", "Helvetica Neue", Helvetica, Arial, HanaMinA, HanaMinB, sim-ch_n5100, SimSun, "Malgun Gothic", "BabelStone Han", Sawndip, SimSun-ExtB, "Nom Na Tong", "Han-Nom Gothic Supplement"' });
    $("body").css({ 'font-family': 'Tahoma, "Tai Lanna", "Cambria Tai", "Lanexang Mon4", "Microsoft New Tai Lue", sans-serif, "Tai Son La", TaiViet, "Segoe Ahom Print", "Helvetica Neue", Helvetica, Arial, HanaMinA, HanaMinB, sim-ch_n5100, SimSun, "Malgun Gothic", "BabelStone Han", Sawndip, SimSun-ExtB, "Nom Na Tong", "Han-Nom Gothic Supplement"' });
    $("#txtPad").css({ 'font-family': 'Cambria, Tahoma, "Tai Lanna", "Cambria Tai", "Lanexang Mon4", "Microsoft New Tai Lue", sans-serif, "Tai Son La", TaiViet, "Segoe Ahom Print", "Helvetica Neue", Helvetica, Arial, HanaMinA, HanaMinB, sim-ch_n5100, SimSun, "Malgun Gothic", "BabelStone Han", Sawndip, SimSun-ExtB, "Nom Na Tong", "Han-Nom Gothic Supplement"' });
    $("#txtPadout").css({ 'font-family': 'Cambria, Tahoma, "Tai Lanna", "Cambria Tai", "Lanexang Mon4", "Microsoft New Tai Lue", sans-serif, "Tai Son La", TaiViet, "Segoe Ahom Print", "Helvetica Neue", Helvetica, Arial, HanaMinA, HanaMinB, sim-ch_n5100, SimSun, "Malgun Gothic", "BabelStone Han", Sawndip, SimSun-ExtB, "Nom Na Tong", "Han-Nom Gothic Supplement"' });
    switch (quocngu) {
...
function txtPadKeyPressed(evt) {
    ...
    if (evtK == 16) {
        if (!shiftbool) {
            ...
            if (subtxt.length > 0)
                $("#example").html("<table><tr><td>" + logo2phon(subtxt, false) + "</td></tr></table>");
        }
    }
...
function convertpad(direction) {
    ...
    switch (direction) {
        case 0:
            convtxt = logo2phon($("#txtPad").val(), true);
            break;
        case 1:
...
function logo2phon(pad, nospace) {
    if (pad == "")
        return "";
...
function speakpad(accentcode) {
    var voice = "";
    var spkcont = "";
    var convtxt = logo2phon($("#txtPad").val(), false);
    if (convtxt.length > 0) {
        switch (accentcode) {
...
function loadkeyboard() {
    ...
    if ($('#keyboard').css("display") == "block") {
        switch (quocngu) {
            ...
            case 25:
                $('#K192').html("<br>`");
                $('#K48').html("<br><span style='color: #6551d9;'>◌𖲀 </span>");

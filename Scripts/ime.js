    ...
    switch (quocngu) {
        ...
        case 27: opttable = "rubytaideng";
            ...
            document.getElementById('accentipa').innerHTML = ('<li onclick="logo2ipa(\'MuongDaeng\',20)"><a>IPA: ' + $("#MuongDaeng").val() + '</a></li>' +
                ...
                '<li onclick="roma2phone()"><a>abc → ꪕ</a></li>' +
                '<li onclick="convertpad(0,20)"><a>文 → ꪕ</a></li>' + convertdeftext);
            $("body").css({ 'font-family': $("body").css('font-family').replace("Muong Lo Cursive", "Muong Deng Sans") });
            $("#keyboard").css({ 'font-family': $("#keyboard").css('font-family').replace("Muong Lo Cursive", "Muong Deng Sans") });
            $("#txtPad").css({ 'font-family': $("#txtPad").css('font-family').replace("Muong Lo Cursive", "Muong Deng Sans") });
            $("#txtPadout").css({ 'font-family': $("#txtPadout").css('font-family').replace("Muong Lo Cursive", "Muong Deng Sans") });
            break;
        case 0:

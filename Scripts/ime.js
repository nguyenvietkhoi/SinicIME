...
function opttableselect(tablesel) {
    quocngu = tablesel;
    $("#keyboard").css({ 'font-family': 'Tahoma, "Tai Lanna", "Cambria Tai Yo", "Lanexang Mon4", "Microsoft New Tai Lue", sans-serif, "Tai Son La", TaiViet, "Segoe Ahom Print", "Helvetica Neue", Helvetica, Arial, HanaMinA, HanaMinB, SimSun, FSung-2, FSung-3, "Malgun Gothic", "BabelStone Han", Sawndip, SimSun-ExtB, Sukhothai, "Nom Na Tong", "Han-Nom Gothic Supplement"' });
    $("body").css({ 'font-family': 'Tahoma, "Tai Lanna", "Cambria Tai Yo", "Lanexang Mon4", "Microsoft New Tai Lue", sans-serif, "Tai Son La", TaiViet, "Segoe Ahom Print", "Helvetica Neue", Helvetica, Arial, HanaMinA, HanaMinB, SimSun, FSung-2, FSung-3, "Malgun Gothic", "BabelStone Han", Sawndip, SimSun-ExtB, Sukhothai, "Nom Na Tong", "Han-Nom Gothic Supplement"' });
    ...
    if ($('#keyboard').css("display") == "block") {
        switch (quocngu) {
            ...
            case 18:
                ...
                $('#K87').html("<span style='color: #b1bb13;'>ꪷ‍</span><br><span style='color: #7ba064;'>ꪷ</span>");
                $('#K69').html("<br>ꪹ");
                $('#K82').html("<span style='color: #d22e9f;'>ꪧ   </span><span style='color: #b1bb13;'>ꪦ</span><br><span style='color: #7ba064;'>ꪭ</span>");
                $('#K84').html("<span style='color: #d22e9f;'>ꪕ   </span><br>ꪔ");
                $('#K89').html("<span style='color: #13abbb;'>ꪤ‍   </span><br>ꪥ");
